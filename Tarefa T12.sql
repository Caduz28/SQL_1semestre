...
create table funcionarios (idFuncionario integer not null, nomeFuncionario varchar(100) not null, dataAdmissaoFuncionario varchar(20) not null, salarioFuncionario varchar(15) not null, funcaoFuncionario varchar(100) not null, idSupervisor varchar(4) null, primary key (idFuncionario)); 
...
create table automoveis (idAutomovel integer not null, fabricanteAutomovel varchar(50) not null, anoAutomovel integer not null, modeloAutomovel varchar(50) not null, chassiAutomovel varchar(100) not null, idFuncionario integer null, primary key (idAutomovel)); 
...
select*from automoveis order by modeloAutomovel DESC;
select*from automoveis where fabricanteAutomovel LIKE "%Volkswagen%" order by anoAutomovel ASC;
